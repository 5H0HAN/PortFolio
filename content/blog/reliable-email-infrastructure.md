...
tags: [email-infrastructure, google-workspace, dns, security]
...
2. Create SPF record with only one hard include.
3. Add DKIM keys and publish the selector.
4. Enable DMARC with a reporting-only policy before enforcing.
